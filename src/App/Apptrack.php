...
namespace Ranj\UmengOpenAPI\App;
...
class Apptrack extends AbstractApplication
{
    ...
    protected function getParamObject()
    {
        ...
        $className = "\\Ranj\\UmengOpenAPI\\com\\umeng\\apptrack\\param\\UmengApptrack{$apiName}Param";
    ...
    {
        $apiName = ucfirst($this->apiName);
        $className = "\\Ranj\\UmengOpenAPI\\com\\umeng\\apptrack\\param\\UmengApptrack{$apiName}Result";
        return new $className();
    }
