...
use Roiwk\UmengOpenAPI\com\umeng\uapp\param\UmengUappCountData;
...
class UmengUappGetNewUsersResult
{
    ...
    */
    ...
    public function setStdResult($stdResult)
    {
        ...
        if (array_key_exists("newUserInfo", (array) $this->stdResult)) {
    ...
    public function setArrayResult($arrayResult)
    {
        ...
        if (array_key_exists("newUserInfo",(array)  $this->arrayResult)) {
