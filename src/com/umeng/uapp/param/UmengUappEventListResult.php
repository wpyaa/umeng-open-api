...
use Roiwk\UmengOpenAPI\com\umeng\uapp\param\UmengUappEventInfo;
...
class UmengUappEventListResult
{
    ...
    */
    ...
    public function setStdResult($stdResult)
    {
        ...
        if (array_key_exists("eventInfo",(array)  $this->stdResult)) {
        ...
        if (array_key_exists("totalPage",(array)  $this->stdResult)) {
    ...
    public function setArrayResult($arrayResult)
    {
        ...
        if (array_key_exists("eventInfo", (array) $this->arrayResult)) {
        ...
        if (array_key_exists("totalPage",(array)  $this->arrayResult)) {
