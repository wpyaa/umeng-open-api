...
use Ranj\UmengOpenAPI\com\umeng\uapp\param\UmengUappAppInfoData;
...
class UmengUappGetAppListResult
{
    ...
    */
    ...
    public function setStdResult($stdResult)
    {
        ...
        if (array_key_exists("appInfos",(array)  $this->stdResult)) {
    ...
    public function setArrayResult($arrayResult)
    {
        ...
        if (array_key_exists("appInfos",(array)  $this->arrayResult)) {
