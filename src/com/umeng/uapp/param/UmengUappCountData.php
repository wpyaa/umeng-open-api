...
use Ranj\UmengOpenAPI\com\umeng\uapp\param\UmengUappCountDataNameValue;
...
class UmengUappCountData extends SDKDomain
{
    ...
    */
    ...
    public function setStdResult($stdResult)
    {
        ...
        if (array_key_exists("dailyValue", (array) $this->stdResult)) {
        ...
        if (array_key_exists("hourValue",(array)  $this->stdResult)) {
    ...
    public function setArrayResult($arrayResult)
    {
        ...
        if (array_key_exists("dailyValue",(array)  $this->arrayResult)) {
        ...
        if (array_key_exists("hourValue", (array) $this->arrayResult)) {
