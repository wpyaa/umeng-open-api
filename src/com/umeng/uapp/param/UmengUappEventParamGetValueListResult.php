...
use Ranj\UmengOpenAPI\com\umeng\uapp\param\UmengUappParamValueInfo;
...
class UmengUappEventParamGetValueListResult
{
    ...
    */
    ...
    public function setStdResult($stdResult)
    {
        ...
        if (array_key_exists("paramInfos",(array)  $this->stdResult)) {
    ...
    public function setArrayResult($arrayResult)
    {
        ...
        if (array_key_exists("paramInfos",(array)  $this->arrayResult)) {
