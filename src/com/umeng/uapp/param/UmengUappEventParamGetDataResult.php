...
use Ranj\UmengOpenAPI\com\umeng\uapp\param\UmengUappDateCountInfo;
...
class UmengUappEventParamGetDataResult
{
    ...
    */
    ...
    public function setStdResult($stdResult)
    {
        ...
        if (array_key_exists("paramValueData",(array) $this->stdResult)) {
    ...
    public function setArrayResult($arrayResult)
    {
        ...
        if (array_key_exists("paramValueData", (array) $this->arrayResult)) {
