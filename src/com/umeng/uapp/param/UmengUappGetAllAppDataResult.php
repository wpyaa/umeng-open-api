...
use Ranj\UmengOpenAPI\com\umeng\uapp\param\UmengUappAllAppData;
...
class UmengUappGetAllAppDataResult
{
    ...
    */
    ...
    public function setStdResult($stdResult)
    {
        ...
        if (array_key_exists("allAppData", (array) $this->stdResult)) {
    ...
    public function setArrayResult($arrayResult)
    {
        ...
        if (array_key_exists("allAppData",(array)  $this->arrayResult)) {
