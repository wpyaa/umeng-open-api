...
class UmengUappAllAppData extends SDKDomain
{
    ...
    */
    ...
    public function setStdResult($stdResult)
    {
        ...
        if (array_key_exists("todayActivityUsers",(array)  $this->stdResult)) {
            $this->todayActivityUsers = $this->stdResult->{"todayActivityUsers"};
        }
        if (array_key_exists("todayNewUsers", (array) $this->stdResult)) {
            $this->todayNewUsers = $this->stdResult->{"todayNewUsers"};
        }
        if (array_key_exists("todayLaunches",(array)  $this->stdResult)) {
            $this->todayLaunches = $this->stdResult->{"todayLaunches"};
        }
        if (array_key_exists("yesterdayActivityUsers", (array) $this->stdResult)) {
            $this->yesterdayActivityUsers = $this->stdResult->{"yesterdayActivityUsers"};
        }
        if (array_key_exists("yesterdayNewUsers", (array) $this->stdResult)) {
            $this->yesterdayNewUsers = $this->stdResult->{"yesterdayNewUsers"};
        }
        if (array_key_exists("yesterdayLaunches", (array) $this->stdResult)) {
            $this->yesterdayLaunches = $this->stdResult->{"yesterdayLaunches"};
        }
        if (array_key_exists("yesterdayUniqNewUsers", (array) $this->stdResult)) {
