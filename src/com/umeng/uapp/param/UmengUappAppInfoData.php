...
class UmengUappAppInfoData extends SDKDomain
{
    ...
    */
    ...
    public function setStdResult($stdResult)
    {
        ...
        if (array_key_exists("updatedAt",(array)  $this->stdResult)) {
            $this->updatedAt = $this->stdResult->{"updatedAt"};
        }
        if (array_key_exists("useGameSdk", (array) $this->stdResult)) {
            $this->useGameSdk = $this->stdResult->{"useGameSdk"};
        }
        if (array_key_exists("name", (array) $this->stdResult)) {
            $this->name = $this->stdResult->{"name"};
        }
        if (array_key_exists("createdAt",(array)  $this->stdResult)) {
            $this->createdAt = $this->stdResult->{"createdAt"};
        }
        if (array_key_exists("appkey", (array) $this->stdResult)) {
            $this->appkey = $this->stdResult->{"appkey"};
        }
        if (array_key_exists("category",(array)  $this->stdResult)) {
            $this->category = $this->stdResult->{"category"};
        }
        if (array_key_exists("popular",(array)  $this->stdResult)) {
    ...
    public function setArrayResult($arrayResult)
    {
        ...
        if (array_key_exists("updatedAt",(array)  $this->arrayResult)) {
            $this->updatedAt = $arrayResult['updatedAt'];
        }
        if (array_key_exists("useGameSdk", (array) $this->arrayResult)) {
            $this->useGameSdk = $arrayResult['useGameSdk'];
        }
        if (array_key_exists("name",(array)  $this->arrayResult)) {
            $this->name = $arrayResult['name'];
        }
        if (array_key_exists("createdAt",(array)  $this->arrayResult)) {
            $this->createdAt = $arrayResult['createdAt'];
        }
        if (array_key_exists("appkey",(array)  $this->arrayResult)) {
            $this->appkey = $arrayResult['appkey'];
        }
        if (array_key_exists("category", (array) $this->arrayResult)) {
            $this->category = $arrayResult['category'];
        }
        if (array_key_exists("popular", (array) $this->arrayResult)) {
